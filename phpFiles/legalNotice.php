...
<!-- head -->
<head>
    <title>Lesson in Violence legal notice</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="robots" content="index,nofollow">
    <meta name="description"
        content="Legal Notice and privacy policy from the Lesson in Violence Website">
    <meta name="keywords"
    ...
    <link rel="stylesheet" type="text/css" href="../cssFiles/legalNotice.css" />
    ...
    <div id="mainContent" class="fluid-container">
        <section>
            <div class="paragraphSection">
                <h3>Legal Notice</h3>
                <p>Responsible for content pursuant to §6 MDSIV Information provided according to Sec. 5 German Telemedia Act (TMG):<br>
                    We do not assume liability for forwarding links on this Homepage.<br>
                    Responsible for content on these sites:<br>
                    Roland Schäfer; Auenstraße 47; 97456 Dittelbrunn; Germany; E-Mail: <a href="mailto:contact@lessoninviolence.com">contact@lessoninviolence.com</a>
                </p>
            </div>
        </section>    
        ...
        <section>
            <div class="paragraphSection">
                ...
                <p>
                    ...
                    Roland Schäfer; Auenstr. 47; D-97456 Dittelbrunn<br>
                    
                    Email: contact@lessoninviolence.com<br>
                    ...
                    If SSL or TLS encryption is activated, the data you transfer to us cannot be read by third parties.<br>
                    ...
                    The basis for data processing is Art. 6 (1) (b) DSGVO, which allows the processing of data to fulfill a contract or for measures preliminary to a contract.<br>
                    ...
                    Further information about handling user data, can be found in the data protection declaration of YouTube under https://www.google.de/intl/de/policies/privacy.<br>
                    ...
                    Further information about handling user data, can be found at https://developers.google.com/fonts/faq and in Google's privacy policy at https://www.google.com/policies/privacy/.<br>
                </p>
            </div>
        </section>
    </div>
