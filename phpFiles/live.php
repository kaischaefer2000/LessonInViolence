...
<body>
    ...
    <div id="mainContent" class="fluid-container">
                ...
                <div class="col">
                    <div class="fluid-container">
                        ...
                        <div class="row details-content flyer-row">
                            ...
                            <div class="col-12 col-sm-9 col-lg-10">
                                <img id="InfernumFlyer" src="../flyer/InfernumFlyer.jpg" alt="Infernum meets Porkcore Fistevil Festival Flyer">
                            </div>
                        </div>
                ...
                <div class="col">
                    <div class="fluid-container">
                        <div class="row details-content">
                            ...
                            <div class="col-9 col-md-9 col-lg-10">
                                <p>Geiselwind / Musichall Strohofer</p>
                            </div>
                        </div>
                ...
                <div class="col">
                    <div class="fluid-container">
                        ...
                        <div class="row details-content flyer-row">
                            ...
                            <div class="col-12 col-sm-9 col-lg-10">
                                <img id="birthdayBashFlyer" src="../flyer/birthday-bash-flyer-min.jpg" alt="Bonebreaker Festival Flyer">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="fluid-container">
                        ...
                        <div class="row details-content flyer-row">
                            ...
                            <div class="col-12 col-sm-9 col-lg-10">
                                <img id="JugendhausEinsFlyer" src="../flyer/lessons-in-metal-1-flyer-min.jpg" alt="Bonebreaker Festival Flyer">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Birthday Moshpit(private party) 2019 -->
        <section>
            <div class="row accordion-item show over">
                <div class="col-11">
                    <p>06.07.2019<p>
